    ...
    {questions.map((que)=>{
        ...
        <div className="right">
          ...
          <button
            ...
            style={{ backgroundColor: "#119872",width:"100px",height:"35px", marginRight:"10px",marginTop:"10px"}}
          >
            <Link to="/addquestion" style={{ textDecoration: 'none', color:"white", fontWeight:"600",fontSize:"0.7rem", }}>
            Write Answer
            </Link>
            </button>
            <button
          ...
          >
            ...
            type="submit"
            className="btn btn-lg btn-block btn-sm text-light"
            style={{ backgroundColor: "#119872",width:"100px",height:"35px",marginTop:"10px"}}
          >
            <Link to="/addquestion" style={{ textDecoration: 'none', color:"white", fontWeight:"600",fontSize:"0.7rem"}}>
            Down Vote
            </Link>
